 ...
 const sampleVideos = [
   { id: "1", title: "Rainbow Dance Party with Friends!", thumbnail: thumbMusic, creator: "Sara's World", category: "music" },
   { id: "2", title: "Learn Animal Sounds - Fun for Kids!", thumbnail: thumbAnimals, creator: "Little Learners", category: "science" },
   { id: "3", title: "Easy DIY Crafts - Make a Rainbow!", thumbnail: thumbCrafts, creator: "Crafty Kids", category: "crafts" },
   { id: "4", title: "The Princess and the Magic Castle", thumbnail: thumbStories, creator: "Story Time", category: "stories" },
   { id: "5", title: "Cool Science Experiments at Home!", thumbnail: thumbScience, creator: "Science Fun", category: "science" },
   { id: "6", title: "Fun Games for Kids - Play Along!", thumbnail: thumbGames, creator: "Game Time", category: "games" },
 ];
 
 const recentSearches = ["dinosaurs", "princess songs", "science experiments", "crafts for kids"];
 const trendingSearches = ["rainbow dance", "animal sounds", "magic castle", "fun games"];
